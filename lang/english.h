...
char *chooseBossText =
  ...
  "of the the network 2:2435, because they are able to help you if you run\n"
  "any trouble (at least concerning fido :) ). It is mainly a question of\n"
  "cost, but because of the massive changes in prices for phone calls (at\n"
  ...
  "equal.\n"
  "The following nodes of the network 2:2435 accept points:\n"
  "\n%s\n"
